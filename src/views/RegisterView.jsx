                ...
                <div className='log-reg-container'>
                    <div className="log-reg-box">
                        ...
                        <div className="field">
                            ...
                            <input autoComplete="off" id="firstname" placeholder="First Name" className="input-field"
                                name="logemail" type="text" ref={firstName} required />
                        </div>
                        ...
                        <div className="field">
                            ...
                            <input autoComplete="off" id="lastname" placeholder="Last Name" className="input-field"
                                name="logemail" type="text" ref={lastName} required />
                        </div>
                        ...
                        <div className="field">
                            ...
                            <input autoComplete="off" id="logemail" placeholder="Email" className="input-field"
                                nameName="logemail" type="email" ref={email} required />
                        </div>
                        ...
                        <div className="field">
                            ...
                            <input autoComplete="off" placeholder="Password" className="input-field" type="password" ref={password} required />
                        </div>
                        ...
                        <div className="field">
                            ...
                            <input autoComplete="off" placeholder="Confirm Password" className="input-field" type="password" ref={confirmedPassword} required />
                        </div>
