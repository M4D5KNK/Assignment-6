...
function LoginView() {
    const { setLoggedIn, password, email } = useStoreContext();
                ...
                <div className='log-reg-container'>
                    <div className="log-reg-box">
                        ...
                        <div className="field">
                            ...
                            <input autocCmplete="off" id="logemail" placeholder="Email" className="input-field"
                                name="logemail" type="email" value={userEmail} onChange={(event) => { setEmail(event.target.value) }} required />
                        </div>
                        <div className="field">
                            <svg className="input-icon" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <input autoComplete="off" id="logpass" placeholder="Password" className="input-field"
                                name="logpass" type="password" value={userPassword} onChange={(event) => { setPassword(event.target.value) }} required />
                        </div>
