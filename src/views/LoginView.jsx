                ...
                <div className='log-reg-container'>
                    <div className="log-reg-box">
                        ...
                        <div className="field">
                            ...
                            <input autocCmplete="off" id="logemail" placeholder="Email" class="input-field"
                                name="logemail" type="email" required />
                        </div>
                        <div className="field">
                            <svg className="input-icon" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <input autoComplete="off" id="logpass" placeholder="Password" class="input-field"
                                name="logpass" type="password" required />
                        </div>
